	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\noindent \underbar{\textbf{UC8 - Brisanje vlastitog treninga}}
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[3.a] Trener se predomisli o brisanju treninga
							\item[] \begin{packed_enum}
					...
					\noindent \underbar{\textbf{UC11 - Brisanje vlastitog turnira}}
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[3.a] Trener se predomisli o brisanju turnira
							\item[] \begin{packed_enum}
		...
		\noindent \underbar{\textbf{UC26 - Brisanje treninga}}
		\begin{packed_item}
		...
		\noindent \underbar{\textbf{UC27 - Dodavanje treninga}}
		\begin{packed_item}
		...
		\noindent \underbar{\textbf{UC28 - Dodavanje turnira}}
		\begin{packed_item}
			...
			\item[] \begin{packed_enum}
				...
				\item Otvara se novi dijaloški okvir s poljima za unos podataka te opcijama "Dodaj" i "Odustani"
				\item Administrator unosi podatke o turniru u dijaloški okvir, odabire trenera kojeg će se smatrati organizatorom tog turnira te odabire opciju "Dodaj"
			...
			\item[] \begin{packed_item}
				...
				\item[4.a] Administrator odustaje od dodavanja novog turnira
				\item[] \begin{packed_enum}
					
					\item Administrator odabire opciju "Odustani" u dijaloškom okviru za unos podataka o turniru
					
				\end{packed_enum}
				\item[4.b] Uneseni podatci o turniru nisu važeći
				\item[] \begin{packed_enum}
		...
		\noindent \underbar{\textbf{UC29 - Brisanje turnira}}
		\begin{packed_item}
			...
			\item[] \begin{packed_item}
				...
				\item[3.a] Administrator odustaje od brisanja turnira
				\item[] \begin{packed_enum}
		...
		\noindent \underbar{\textbf{UC30 - Brisanje dnevne šahovske taktike}}
		\begin{packed_item}
