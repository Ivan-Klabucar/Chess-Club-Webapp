	...
	\section{Funkcionalni zahtjevi}
		...
		\end{packed_item}
			...
			\subsection{Sekvencijski dijagrami}
				...
				\begin{figure}[H]
					\centerfloat
        					\includegraphics[scale=0.40]{dijagrami/ObjavaTaktike.jpg} %veličina slike u odnosu na originalnu datoteku i pozicija slike
        					\caption{Sekvencijski dijagram za UC$<$broj obrasca$>$}
        					\label{fig:UC$<$broj obrasca$>$}
				\end{figure}
				...
				\begin{figure}[H]
					\centerfloat
					\includegraphics[scale=0.40]{dijagrami/RiješavanjeTaktike.jpg} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\caption{Sekvencijski dijagram za UC$<$broj obrasca$>$}
					\label{fig:UC$<$broj obrasca$>$}
				\end{figure}
